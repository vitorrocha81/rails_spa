...
export class FromEventPatternObservable<T, R> extends Observable<T> {
  ...
  protected _subscribe(subscriber: Subscriber<R>) {
  ...
  private _callSelector(subscriber: Subscriber<R>, args: Array<any>): void {
    try {
  ...
  private _callAddHandler(handler: (e: any) => void, errorSubscriber: Subscriber<R>): void {
    try {
