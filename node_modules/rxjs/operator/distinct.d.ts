 ...
 * @extends {Ignored}
 */
export declare class DistinctSubscriber<R> extends OuterSubscriber<T, T> {
    private values;
    constructor(destination: Subscriber<R>, compare: (x: T, y: T) => boolean, flushes: Observable<any>);
