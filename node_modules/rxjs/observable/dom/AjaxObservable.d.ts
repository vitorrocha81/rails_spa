...
export declare class AjaxObservable<T> extends Observable<T> {
    ...
    */
    ...
    protected _subscribe(subscriber: Subscriber<R>): TeardownLogic;
}
/**
 * We need this JSDoc comment for affecting ESDoc.
 * @ignore
 * @extends {Ignored}
 */
export declare class AjaxSubscriber<R> extends Subscriber<Event> {
    request: AjaxRequest;
    private xhr;
    private done;
    constructor(destination: Subscriber<R>, request: AjaxRequest);
    next(e: Event): void;
    private send();
